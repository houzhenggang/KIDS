XPDET	;SFISC/RSD - Input tranforms & help for file 9.6 & 9.7 ;2014-01-10  5:36 PM
	;;8.0;KERNEL;**15,39,41,44,51,58,66,137,229,393,539,10001**;Jul 10, 1995;Build 3
...
INPUTB(X)	;input tranfrom for NAME in BUILD file
	...
	I X["*" K:$P(X,"*",2,3)'?1.2N1"."1.2N.1(1"V",1"T").2N1"*"1.10N X Q
	S %=$L(X," ") I %<2 K X Q
